...
//        }
//
//        public static ArrayList<FinanceModel> getData(SQLiteDatabase db) {
//            Cursor cursor = null;
//            cursor = db.rawQuery("SELECT date(date,'unixepoch'), " +
//                    COLUMN_AMOUNT + ", " + COLUMN_CATEGORY +
//                    " from financeYearlyReports" , null);
//
//            ArrayList<FinanceModel> items = new ArrayList<>();
//
...
//            return items;
//        }
////        public static ArrayList<FinanceModel> getMonthlyData(SQLiteDatabase db) {
////            Cursor cursor = null;
...
////        }
//
//        public static FinanceModel addItem(Cursor cursor) {
